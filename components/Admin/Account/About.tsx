...
export default function About({ user }: { user: IUser | undefined }) {
  ...
  return (
    <div className="lg:px-9 px-3 py-12 shadow-xl rounded-lg">
      ...
      <h2 className="xl:text-h3 text-2xl font-semibold text-center xl:mb-12 mb-6 mt-[37px]">
        {user ? user?.full_name : "Dr. Johirul Islam Nishat"}
      </h2>
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-3">
          <h3 className="xl:text-2xl text-xl">About</h3>
        ...
        <div className="flex justify-between">
          <div className="flex flex-col">
            <h3 className="xl:text-2xl text-xl">Age</h3>
            <p className="xl:text-[18px] text-sm text-black/50 ">17</p>
          </div>
          <div className="flex flex-col">
            <h3 className="xl:text-2xl text-xl">Gender</h3>
            <p className="xl:text-[18px] text-sm text-black/50 ">Male</p>
          </div>
        </div>
        <div className="flex flex-col">
          <h3 className="xl:text-2xl text-xl">Date Of Birth</h3>
