...
export default function Page() {
  ...
  return (
    <div className="max-w-registration flex flex-col items-center">
      ...
      <p className="max-w-[485px] text-black/40 md:text-2xl text-xl text-center mb-20">
        Account Has Been Created. Enjoy Job Task.
      </p>
      <button
        className="border border-primary px-4 md:py-6 py-3 md:text-2xl md:w-[318px] rounded-lg hover:bg-primary hover:text-white "
